...
function App() {
  ...
  return (
    <div className={`bg-gray-100 min-h-screen font-sans ${theme === "dark" ? "bg-gray-800 text-white" : "bg-white text-primary-content"}`}>
      <nav
        id="navbar"
        ...
        <div className="flex space-x-4 items-center">
          <Link
            ...
            className={`btn btn-outline normal-case text-xl ${
              theme === "dark" ? "text-white" : "btn-primary btn-outline outline-2"
            }`}
          >
            About Me
          </Link>
          ...
          {/* Removed Tutoring and Awards links for brevity in this example, add them back if needed */}
